...
def calibrar():
    ...
    print("Usa 'q' para salir y ver el valor final")
    ...
    try:
        while True:
            ...
            cv2.line(frame, (cx, 0), (cx, alto), (255, 0, 0), 1)
            cv2.line(frame, (0, cy_offset), (ancho, cy_offset), (255, 0, 0), 1)
            cv2.circle(frame, (cx, cy_offset), 5, (0, 255, 0), -1)

            cv2.putText(frame, f"OFFSET Y: {offset_y}", (10, 30), 
